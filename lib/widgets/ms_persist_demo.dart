...
class MSPersistDemo extends StatefulWidget {
  MSPersistDemo({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MSPersistDemoState createState() => _MSPersistDemoState();
}

class _MSPersistDemoState extends State<MSPersistDemo> {
  Count _count;
